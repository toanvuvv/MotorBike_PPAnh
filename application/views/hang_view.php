    ...
    <tbody>
      <?php foreach ($alldata as $value): ?>
        <tr>
          ...
          <td>
            <!-- <a href="<?= base_url() ?>admin/delHang/<?= $value['idHang'] ?>" class="btn btn-danger">Delete</a> -->
            <a href="<?= base_url() ?>admin/updateHangView/<?= $value['idHang'] ?>" class="btn btn-success">Update</a>
