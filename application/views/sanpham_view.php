...
<div class="container">
  ...
  <a href="<?= base_url() ?>admin/addSp_view" class="btn btn-success">Thêm</a>
    ...
    <tbody>
      <?php foreach ($alldata as $value): ?>
        <tr>
          ...
          <td><?= $value['dungTichXL'] ?></td>
          <td><?= $value['dungTichBX'] ?></td>
          <td><?= $value['tieuThu'] ?></td>

          <td><img  style=" height: 30px;width: 40px" src="<?= $value['anh'] ?>" ></td>

         
  
          <td>
            <a href="<?= base_url() ?>admin/delSp/<?= $value['idXe'] ?>" class="btn btn-danger">Delete</a>
            <a href="<?= base_url() ?>admin/updateSp_view/<?= $value['idXe'] ?>" class="btn btn-success">Update</a>
          </td>
